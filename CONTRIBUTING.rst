...
Welcome to ``ewoc_classif`` contributor's guide.
...
If you experience bugs or general issues with ``ewoc_classif``, please have a look
...
You can help improve ``ewoc_classif`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``ewoc_classif`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``ewoc_classif``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n ewoc_classif python=3 six virtualenv pytest pytest-cov
    conda activate ewoc_classif
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/ewoc_classif.git
    cd ewoc_classif
...
#. Install |pre-commit|_::
   ...
   ``ewoc_classif`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/ewoc_classif
.. _issue tracker: https://github.com/<USERNAME>/ewoc_classif/issues
.. <-- end -->
